...
object DatabaseMerger {
    ...
    fun merge(
        ...
        try {
            ...
            target.transaction {
                rows += VehicleIdentityMerge.copyVehicles(target, donor, vehicleMap, vehicleCounts, progress)
    ...
    internal fun readRow(c: Cursor): ContentValues {
