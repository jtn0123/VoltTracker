...
import com.volttracker.obdpoc.EnhancedPidProfiles.STAGE_EXPERIMENTAL
import com.volttracker.obdpoc.EnhancedPidProfiles.STAGE_LOW_RISK
import com.volttracker.obdpoc.EnhancedPidProfiles.STAGE_PASSIVE
import com.volttracker.obdpoc.EnhancedPidProfiles.STAGE_TIRES
import com.volttracker.obdpoc.EnhancedPidProfiles.STATUS_CANDIDATE
import com.volttracker.obdpoc.EnhancedPidProfiles.STATUS_CONFIRMED
import com.volttracker.obdpoc.EnhancedPidProfiles.STATUS_REJECTED
import java.util.Collections
import java.util.Locale

/**
 * The Volt enhanced/candidate PID catalog data, extracted from [EnhancedPidProfiles] so the ~600
 * lines of profile definitions live apart from the query API that consumes them. [build] assembles
 * the immutable profile list; [EnhancedPidProfiles.ALL] is initialized from it.
 */
internal object EnhancedPidCatalog {
    ...
    fun build(): List<EnhancedPidProfile> {
