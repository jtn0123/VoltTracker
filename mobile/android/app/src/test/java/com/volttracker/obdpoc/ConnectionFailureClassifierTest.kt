...
/**
 * Drives each heuristic branch of [ConnectionFailureClassifier] against a curated input. The
...
class ConnectionFailureClassifierTest {
    @Test
    fun btOffWinsEvenWhenMessageMatchesOtherBranches() {
    ...
    @Test
    fun sdpFailureMatchesServiceDiscoveryMessages() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "rfcomm_connect",
                250L,
    ...
    @Test
    fun remoteRefusedMatchesConnectionRefusedMessages() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "rfcomm_connect",
                140L,
    ...
    @Test
    fun bondLostMatchesPermissionDeniedMessages() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "rfcomm_connect",
                90L,
    ...
    @Test
    fun bondLostMatchesBondStateChangedMessages() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "rfcomm_connect",
                90L,
    ...
    @Test
    fun connectPhaseFailureWithoutOtherSignalsIsConnectTimeout() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "rfcomm_connect",
                1500L,
    ...
    @Test
    fun getStreamsPhaseFailureIsConnectTimeout() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "get_streams",
                8L,
    ...
    @Test
    fun firstReadFailureUnderThresholdIsInstantDrop() {
    ...
    @Test
    fun firstReadFailureOverThresholdIsConnectTimeout() {
    ...
    @Test
    fun unknownPhaseAndUnknownMessageBucketsAsUnknown() {
        val input =
            ConnectionFailureClassifier.ofRaw(
                "post_connect",
                100L,
    ...
    @Test
    fun nullInputDefaultsToUnknown() {
        assertEquals(
            FailureClass.UNKNOWN,
            ConnectionFailureClassifier.classify(null as Input?),
        )
    }

    @Test
    fun ofConvenienceLowercasesMessage() {
        // Mixed-case message must still match the lowercased heuristic.
        val ex = IOException("Service Discovery Failed")
        assertEquals(
    ...
    @Test
    fun ofConvenienceHandlesNullExceptionMessage() {
