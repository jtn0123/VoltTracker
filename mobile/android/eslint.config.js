...
// deliberately conservative — recommended + a few targeted rules — so it never fights
// legitimate dashboard idioms. (The SOURCE is typed ESM TypeScript since the C7 migration;
// only the esbuild OUTPUT is classic-script IIFEs, because modules don't load over file://.)
//
