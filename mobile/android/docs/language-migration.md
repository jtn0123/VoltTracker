...
> |---|---:|---:|---:|---|
> | Kotlin files converted | 29 | 0 | tested helper candidates | K0–K3 done; K5 started; BackupController stays Java |
...
- Convert next: `WebViewBootstrap.java` is small and directly tested, but should stay in its own
  commit because it touches WebView settings and origin navigation behavior.
